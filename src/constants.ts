...
export const IONIC_SCRIPTS = 'ionic-scripts';
...
export const SCRIPTS_ROOT = join(PROJECT_ROOT, NODE_MODULES, IONIC_SCRIPTS);
export const SCRIPTS_GENERATED_DIR = join(SCRIPTS_ROOT, SCRIPTS_GENERATED_DIR_NAME);
export const INTERNAL_BUILD_DIR = join(SCRIPTS_GENERATED_DIR, BUILD);

// js bundle stuff
export const INTERNAL_BUILD_BUNDLES_DIR = join(SCRIPTS_GENERATED_DIR, 'bundles');
